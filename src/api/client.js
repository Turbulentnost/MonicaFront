...
export const chatsApi = {
  ...
  pinned: (chatId) => api.get(`/chats/${chatId}/pinned/`),
  pinMessage: (chatId, messageId) => api.post(`/chats/${chatId}/messages/${messageId}/pin/`),
  unpinMessage: (chatId, messageId) => api.delete(`/chats/${chatId}/messages/${messageId}/pin/`),
